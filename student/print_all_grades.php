...
<body>
	...
	<div class="container">
     ...
     <!--  <div class="col-md-12">
      ...
      ?>
			<div class="col-md-12">
        <h5>S.Y. <span style="color: darkred; font-weight: bold;"><?php echo $acadyears['academic_year']; ?></span></h5>
            ...
            <tbody>
              ...
              <?php   
                $counter = 0;
                $average_sum = 0;
                  $selectStudSched = ' SELECT `id`, `student_id`, `schedule_id`, `date_created`, `academic_year_id` FROM `tbl_student_schedule` WHERE student_id = '.$_GET['student_id'].' AND academic_year_id = '.$acadyears['id'];
