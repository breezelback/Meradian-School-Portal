...
<div class="wrapper">
              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                  <ul class="nav nav-pills ml-auto">
                    <li class="nav-item">
                      <button class="nav-link btn-success text-white" data-toggle="modal" data-target="#modal_student_liability">Add Student Liability &nbsp;<i class="fa fa-user-plus"></i></button>
                    </li>
                  </ul>
                </div>
              </div><!-- /.card-header -->
  ...
  <!-- Modal -->
  <form action="../function_php/add_student_liability.php" method="POST">
      ...
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Add Student Liabilities</h5>
                ...
                <tbody>
                  ...
                  ?>
                    <tr style="font-size: 14px;">
                      ...
                      <td><center><input type="text" class="form-control" name="liability[<?php echo $sub['id']; ?>]"></center></td>
